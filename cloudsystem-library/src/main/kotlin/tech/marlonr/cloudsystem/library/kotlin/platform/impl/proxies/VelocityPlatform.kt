...
class VelocityPlatform(private val httpClient: HttpClient): IPlatform {
    ...
    override suspend fun downloadJarFile(path: Path, mcVersion: String, build: String): Boolean {
        return downloadFile(
            httpClient,
            URL("https://api.papermc.io/v2/projects/velocity/versions/$mcVersion/builds/$build/downloads/velocity-$mcVersion-$build.jar"),
            path
        )
    }
